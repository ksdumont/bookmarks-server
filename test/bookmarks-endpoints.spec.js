...
describe("Bookmarks Endpoints", () => {
  ...
  describe("POST /api/bookmarks", () => {
    it(`responds with 400 and missing 'title' if not supplied`, () => {
    ...
    it(`responds with 400 and missing 'url' if not supplied`, () => {
    ...
    it(`responds with 400 and missing 'rating' if not supplied`, () => {
